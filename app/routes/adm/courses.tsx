...
export const action: ActionFunction = async ({ request }) => {
  ...
  if (
    ...
    typeof parRating === "string" &&
    typeof ratingDiff === "string" &&
    typeof parScore === "string"
  ) {
    if (request.method === "POST") {
      await prisma.course.create({
        data: {
          courseId,
          name: courseName,
          parRating: parseInt(parRating),
          ratingDiff: parseInt(ratingDiff),
          parScore: parseInt(parScore),
        },
      });
    }
